...
; uP: Intel Core i7 7500U @ 2.70GHz
; Program: Hello
; Compiler: (NASM 2.13.03rc1, GCC 5.1.0)
; OS: Windows 10 64-bit
; Program Version: 1.0
;
; Program Description: This Program Allows a processor to use assembly to
;                      display text to an output window
;
; Created January 25th, 2018, 1:39 AM
; ---------------------------------------------------------------------------
